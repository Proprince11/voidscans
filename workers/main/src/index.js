...
//   /api/upload                  POST   Catbox/R2 proxy (single file)
//   /api/bulk-upload             POST   Catbox/R2 proxy (many files)
//   /api/scrape                  GET    Scrape image URLs from a webpage
//   /api/scrape-rehost           POST   Download given URLs and re-upload
...
import { handleUpload, handleBulkUpload } from './upload.js';
import { handleScrape, handleScrapeRehost } from './scrape.js';
import { handleMangaDexProxy } from './proxy.js';
